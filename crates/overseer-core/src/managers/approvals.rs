...
use crate::persistence::approvals::{load_approvals, save_approvals};
use crate::persistence::types::ApprovalsData;
...
impl ProjectApprovalManager {
    /// Create a new ProjectApprovalManager.
    pub fn new() -> Self {
        Self::default()
    }
    ...
    pub fn get_or_load(&self, project_name: &str) -> ApprovalContext {
        ...
        log::info!(
            "Loading approvals from disk for '{}', dir: {:?}",
            project_name,
            dir
        );
    ...
    pub fn add_approval(
        ...
        // Now update the cached context
        {
            ...
            if let Some(ctx) = contexts.get_mut(project_name) {
                ...
                log::warn!(
                    "[add_approval] No context found for project '{}'",
                    project_name
                );
            }
        }
    ...
    pub fn remove_approval(
    ...
    ) -> Result<(), String> {
        {
            ...
            if let Some(ctx) = contexts.get_mut(project_name) {
                ...
                log::warn!(
                    "[remove_approval] No context found for project '{}'",
                    project_name
                );
            }
        }
...
mod tests {
    ...
    fn test_add_tool_approval() {
        ...
        // Add tool approval
        manager
            .add_approval("test-project", "Write", false)
            .unwrap();
