...
- MCP server (`/mcp`) — the same driving verbs exposed as MCP tools, behind the HTTP server's bearer token. See [features/27-mcp-server.md](features/27-mcp-server.md)
